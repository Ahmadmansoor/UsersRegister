...
Namespace IOUsersDataSetTableAdapters
    ...
    Partial Public Class InOutTableTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@DifTime", Global.System.Data.SqlDbType.DateTime, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "DifTime", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_DifTime", Global.System.Data.SqlDbType.DateTime, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "DifTime", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT        InOutId, UserId, UserName, TimeIn, TimeOut, DifTime"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM          "& _ 
                "  InOutTable"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (TimeOut = @TimeOut) AND (UserId = @UserId)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@TimeOut", Global.System.Data.SqlDbType.DateTime, 8, Global.System.Data.ParameterDirection.Input, 0, 0, "TimeOut", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        ...
        Public Overloads Overridable Function FillBy_CheckUserIfGoOut(ByVal dataTable As IOUsersDataSet.InOutTableDataTable, ByVal TimeOut As Global.System.Nullable(Of Date), ByVal UserId As Global.System.Nullable(Of Integer)) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (TimeOut.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(TimeOut.Value,Date)
            Else
        ...
        Public Overloads Overridable Function GetDataBy_CheckUserIfGoOut(ByVal TimeOut As Global.System.Nullable(Of Date), ByVal UserId As Global.System.Nullable(Of Integer)) As IOUsersDataSet.InOutTableDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (TimeOut.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(TimeOut.Value,Date)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Overridable Function Delete(ByVal Original_InOutId As Integer, ByVal Original_UserId As Global.System.Nullable(Of Integer), ByVal Original_UserName As String, ByVal Original_TimeIn As Global.System.Nullable(Of Date), ByVal Original_TimeOut As Global.System.Nullable(Of Date), ByVal Original_DifTime As Global.System.Nullable(Of Date)) As Integer
            ...
            If (Original_DifTime.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(10).Value = CType(Original_DifTime.Value,Date)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal UserId As Global.System.Nullable(Of Integer), ByVal UserName As String, ByVal TimeIn As Global.System.Nullable(Of Date), ByVal TimeOut As Global.System.Nullable(Of Date), ByVal DifTime As Global.System.Nullable(Of Date), ByVal Original_InOutId As Integer, ByVal Original_UserId As Global.System.Nullable(Of Integer), ByVal Original_UserName As String, ByVal Original_TimeIn As Global.System.Nullable(Of Date), ByVal Original_TimeOut As Global.System.Nullable(Of Date), ByVal Original_DifTime As Global.System.Nullable(Of Date), ByVal InOutId As Integer) As Integer
            If (UserId.HasValue = true) Then
            ...
            End If
            If (DifTime.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(DifTime.Value,Date)
            Else
                Me.Adapter.UpdateCommand.Parameters(4).Value = Global.System.DBNull.Value
            End If
            ...
            If (Original_DifTime.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(14).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(15).Value = CType(Original_DifTime.Value,Date)
            Else
                Me.Adapter.UpdateCommand.Parameters(14).Value = CType(1,Object)
                Me.Adapter.UpdateCommand.Parameters(15).Value = Global.System.DBNull.Value
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal UserId As Global.System.Nullable(Of Integer), ByVal UserName As String, ByVal TimeIn As Global.System.Nullable(Of Date), ByVal TimeOut As Global.System.Nullable(Of Date), ByVal DifTime As Global.System.Nullable(Of Date), ByVal Original_InOutId As Integer, ByVal Original_UserId As Global.System.Nullable(Of Integer), ByVal Original_UserName As String, ByVal Original_TimeIn As Global.System.Nullable(Of Date), ByVal Original_TimeOut As Global.System.Nullable(Of Date), ByVal Original_DifTime As Global.System.Nullable(Of Date)) As Integer
